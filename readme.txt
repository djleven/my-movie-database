...
Have a look at this demo video to see the basics and visit the [my movie database website](https://mymoviedb.org) for full details.

[youtube https://youtu.be/vUGGxX7maTg]

The data comes from the API of [The Movie Database (TMDb)](https://www.themoviedb.org), the leading crowdsourced movie industry data initiative. This calls made to the [TMDb api](https://www.themoviedb.org/documentation/api) are provided free of charge.
...
## Version 3 brings many new features and improvements
...
You can find the [plugin changelog](https://mymoviedb.org/changelog/) on our website.

Developers, check out the [project repository on github](https://github.com/djleven/my-movie-database/).
